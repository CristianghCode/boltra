...
@Entity
@Table(name = "BTW_BT_FORM_ESP_TRIBUNAL")
public class FormacionEspecializadaTribunal {
	
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sec_form_esp_tribunal")
	@SequenceGenerator(
			name="sec_form_esp_tribunal", sequenceName = "BOLTRA.SEQ_FORM_ESP_TRIBUNAL",
		    allocationSize = 1
		)
	@Column(name = "ID")
	private Long id;
	...
	@OneToOne
	@JoinColumn(name = "ID_FORM_ESP")
	private FormacionEspecializada formacionEspecializada;
	...
	public FormacionEspecializada getFormacionEspecializada() {
		return formacionEspecializada;
	}


	public void setFormacionEspecializada(FormacionEspecializada formacionEspecializada) {
		this.formacionEspecializada = formacionEspecializada;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((formacionEspecializada == null) ? 0 : formacionEspecializada.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FormacionEspecializadaTribunal other = (FormacionEspecializadaTribunal) obj;
		...
		if (fechaFinalizacion == null) {
			...
			return false;
		if (formacionEspecializada == null) {
			if (other.formacionEspecializada != null)
				return false;
		} else if (!formacionEspecializada.equals(other.formacionEspecializada))
			return false;
		if (id == null) {
			if (other.id != null)
				return false;
